...
public class SuperArmour : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        //transform.localScale =  StaticMethods.getPixelPerfectPos(transform.localScale);
        //transform.localPosition = StaticMethods.getPixelPerfectPos(transform.localPosition);
    }
}
